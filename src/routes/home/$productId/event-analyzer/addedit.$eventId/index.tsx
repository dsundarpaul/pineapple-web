...
function RouteComponent() {
  ...
  const testSave = async () => {
    const payload = {
    eventName: "Tech Conference 2021",
    eventAgenda: "Day 1: Keynotes, Day 2: Workshops",
    eventDescription: "Annual technology conference",
    eventStartDateTime: new Date("2021-06-01T09:00:00Z"),
    eventEndDateTime: new Date("2021-06-02T18:00:00Z"),
    eventLocation: "Pune",
    eventVenue: "Main Hall",
    eventVenueCapacity: 500,
    speakers: [
      {
        name: "John Doe",
        company: "Tech Corp",
        designation: "CTO",
        bio: "20 years of experience in tech",
  ...
  try {
    const response = await adminApi.post( `/events/products/${productId}`,
      payload,
      {
        headers: {
    ...
    await adminApi.get( `/events/products/${productId}`,
      {
        params: {
  ...
  return (
    <div className='pb-6'>
      <button onClick={() => testSave()}>Test submit</button>
